...
from scheduler.forms import JobAdminForm  # isn't currently used
...
class ScheduledJobAdmin(QueueMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "callable", "enabled",),}),
        (_("RQ Settings"), {"fields": ("queue", "job_id",),}),
        (
            _("Scheduling"),
            {
                "fields": ("scheduled_time", "timeout", "result_ttl"),
                "description": _(
                    "Please be aware: Scheduled Time has to be in the future."
                ),
            },
        ),
    )
...
class CronJobAdmin(QueueMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "callable", "enabled",),}),
        (_("RQ Settings"), {"fields": ("queue", "job_id",),}),
        (_("Scheduling"), {"fields": ("cron_string", "repeat", "timeout",),}),
    )
